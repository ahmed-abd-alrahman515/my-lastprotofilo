  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn("flex max-w-md flex-col gap-4", isRtl && "text-right")}
      >
        <motion.div
...
function MobileOrbital({ projects }: { projects: Project[] }) {
  ...
  return (
    <div className="relative overflow-hidden px-4 pb-6">
      <div
        aria-hidden
        className={cn(
          "pointer-events-none absolute inset-x-[14%] top-8 h-56 rounded-full blur-3xl",
          activeTheme.glow,
        )}
      />
      <div className="relative mx-auto max-w-md">
        <div className={cn("mb-5 space-y-4", isRtl && "text-right")}>
              ...
              >
                ...
                <div className="space-y-3 p-4">
                  ...
                  <div className="flex items-center justify-between border-t border-foreground/6 pt-3">
                    ...
                    <ArrowUpRight className={cn("h-4 w-4 transition-transform duration-300", theme.text, isActive && "translate-x-0.5 -translate-y-0.5")} />
                  </div>
                </div>
              </button>
            );
