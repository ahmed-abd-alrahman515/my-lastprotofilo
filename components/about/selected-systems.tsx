...
export function SelectedSystems() {
  ...
  return (
    <section className="relative isolate overflow-hidden py-24 sm:py-32">
          ...
          <div className="max-w-2xl">
            ...
            <Reveal delay={0.06}>
              <Heading as="h2" size="md" className="mt-4">
                A few systems I&apos;ve shipped end to end.
              </Heading>
            </Reveal>
            <Reveal delay={0.12}>
              <Lead className="mt-5">Drag, scroll, or use the arrows — then open any case study.</Lead>
            </Reveal>
          </div>
      ...
      >
        {/* leading spacer to center first card on large screens */}
